  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        prop="goodsId"
      />
      <el-table-column label="玩家昵稱" align="center" prop="goodsName" />
      ...
      <el-table-column label="兌換商品logo" align="center">
        <template slot-scope="scope">
          <el-image
            style="width: 100px; height: 100px"
            :src="scope.row.goodsLogo"
      ...
      <el-table-column label="兌換商品名稱" align="center" prop="goodsStock" />
      <el-table-column label="兌換商品描述" align="center" prop="goodsStock" />
      <el-table-column label="兌換時間" align="center" prop="goodsStock" />
      <el-table-column label="兌換狀態" align="center" prop="goodsStock" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <!-- <el-form-item label="添加人员" prop="createBy">
          <el-input v-model="form.createBy" placeholder="請輸入添加人员" />
        </el-form-item> -->
      </el-form>
