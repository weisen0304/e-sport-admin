  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="任务组名" prop="jobGroup">
        <el-select v-model="queryParams.jobGroup" placeholder="請選擇任务组名" clearable size="small">
          <el-option
      ...
      <el-form-item label="任务状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="請選擇任务状态" clearable size="small">
          <el-option
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="任务名称" prop="jobName">
              <el-input v-model="form.jobName" placeholder="請輸入任务名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="24">
            <el-form-item prop="invokeTarget">
              ...
              <el-input v-model="form.invokeTarget" placeholder="請輸入调用目标字符串" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="cron表达式" prop="cronExpression">
              <el-input v-model="form.cronExpression" placeholder="請輸入cron执行表达式" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
