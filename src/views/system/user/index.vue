    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        >
          ...
          <el-table-column label="用戶編號" align="center" prop="userId" />
          <el-table-column
            label="用戶名稱"
            align="center"
            prop="userName"
  ...
  methods: {
    ...
    handleAdd() {
      ...
      getUser().then((response) => {
        ...
        this.roleOptions = response.roles.data;
        this.open = true;
        this.title = "添加用戶";
    ...
    handleUpdate(row) {
      ...
      getUser(userId).then((response) => {
        ...
        let sexIndex = parseInt(userInfo.sex);
        this.form = {
          ...
          sex: this.sexOptions[sexIndex].dictValue,
