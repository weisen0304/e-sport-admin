<template>
  <div class="right-board">
    <el-tabs v-model="currentTab" class="center-tabs">
      ...
      <el-tab-pane label="表單属性" name="form" />
    </el-tabs>
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.label!==undefined" label="标题">
            <el-input v-model="activeData.label" placeholder="請輸入标题" />
          </el-form-item>
          <el-form-item v-if="activeData.placeholder!==undefined" label="占位提示">
            <el-input v-model="activeData.placeholder" placeholder="請輸入占位提示" />
          </el-form-item>
          <el-form-item v-if="activeData['start-placeholder']!==undefined" label="开始占位">
            <el-input v-model="activeData['start-placeholder']" placeholder="請輸入占位提示" />
          </el-form-item>
          <el-form-item v-if="activeData['end-placeholder']!==undefined" label="结束占位">
            <el-input v-model="activeData['end-placeholder']" placeholder="請輸入占位提示" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.labelWidth!==undefined" label="标签宽度">
            <el-input v-model.number="activeData.labelWidth" type="number" placeholder="請輸入标签宽度" />
          </el-form-item>
          <el-form-item v-if="activeData.style&&activeData.style.width!==undefined" label="组件宽度">
            <el-input v-model="activeData.style.width" placeholder="請輸入组件宽度" clearable />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.append!==undefined" label="后缀">
            <el-input v-model="activeData.append" placeholder="請輸入后缀" />
          </el-form-item>
          <el-form-item v-if="activeData['prefix-icon']!==undefined" label="前图标">
            <el-input v-model="activeData['prefix-icon']" placeholder="請輸入前图标名称">
          ...
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="后图标">
            <el-input v-model="activeData['suffix-icon']" placeholder="請輸入后图标名称">
          ...
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="选项分隔符">
            <el-input v-model="activeData.separator" placeholder="請輸入选项分隔符" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.maxlength !== undefined" label="最多输入">
            <el-input v-model="activeData.maxlength" placeholder="請輸入字符长度">
          ...
          <el-form-item v-if="activeData['active-text'] !== undefined" label="开启提示">
            <el-input v-model="activeData['active-text']" placeholder="請輸入开启提示" />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-text'] !== undefined" label="关闭提示">
            <el-input v-model="activeData['inactive-text']" placeholder="請輸入关闭提示" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.name !== undefined" label="文件字段名">
            <el-input v-model="activeData.name" placeholder="請輸入上传文件字段名" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.action !== undefined" label="上传地址">
            <el-input v-model="activeData.action" placeholder="請輸入上传地址" clearable />
          </el-form-item>
          ...
          <el-form-item
            ...
            label="按钮文字"
          >
            <el-input v-model="activeData.buttonText" placeholder="請輸入按钮文字" />
          </el-form-item>
          ...
          <template v-if="['el-cascader'].indexOf(activeData.tag) > -1">
            ...
            <template v-if="activeData.dataType === 'dynamic'">
              <el-form-item label="标签键名">
                <el-input v-model="activeData.labelKey" placeholder="請輸入标签键名" />
              </el-form-item>
              <el-form-item label="值键名">
                <el-input v-model="activeData.valueKey" placeholder="請輸入值键名" />
              </el-form-item>
              <el-form-item label="子级键名">
                <el-input v-model="activeData.childrenKey" placeholder="請輸入子级键名" />
              </el-form-item>
            </template>
          ...
          <el-form-item v-if="activeData.tag === 'el-select'" label="是否可蒐索">
            <el-switch v-model="activeData.filterable" />
          </el-form-item>
          ...
          <template v-if="activeData.layout === 'colFormItem'">
            ...
            >
              ...
              <el-form-item label="表达式">
                <el-input v-model="item.pattern" placeholder="請輸入正则" />
              </el-form-item>
              <el-form-item label="错误提示" style="margin-bottom:0">
                <el-input v-model="item.message" placeholder="請輸入错误提示" />
              </el-form-item>
            </div>
            <div style="margin-left: 20px">
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          ...
          <el-form-item label="表單模型">
            <el-input v-model="formConf.formModel" placeholder="請輸入数据模型" />
          </el-form-item>
          <el-form-item label="校验模型">
            <el-input v-model="formConf.formRules" placeholder="請輸入校验模型" />
          </el-form-item>
